...
**Flow cannot render your app's screen.** Ask Veo for a phone showing `Sign waiver now` and
you get a convincing phone with warped nonsense on it. Every attempt to fix this wastes an
afternoon.

So the video runs on two tracks:

| Track | What it covers | Where it comes from |
| :--- | :--- | :--- |
| **The world** | espresso, scooters, hands, the parking lot, kickstands | Flow |
| **The screens** | every button, every label, every result card | Screenshots you take, composited in the edit |

Every Flow prompt below therefore ends with **`phone screen not readable`** on purpose. The
phone is in shot; the content of it is not. Then you cut, or picture-in-picture, to the real
screenshot with a circle on the thing that matters.

This is how good software training videos are actually made. It is also less work.
...
Both are 15 segments × 8 seconds = **2:00**.

---

## Before you prompt anything: load your Ingredients

Flow's **Ingredients to Video** is the reason these 15 clips will look like one film instead
of fifteen. Upload these once and reference them in every shot.
...
gentle 35mm film grain, shallow depth of field, unhurried handheld camera with subtle drift.
...
The club is Italian-adjacent and everyone rides a Vespa. That earns a light touch, not a
costume.
...
SHOT: A stovetop moka pot beginning to bubble on a gas ring in a small kitchen. Beside it on a
wooden table, a motorcycle helmet resting on a chair and a set of keys. Morning light through a
window behind. Nobody in frame yet.

CAMERA: Slow push in on the moka pot, then a gentle rack focus to the helmet.

AUDIO: The moka pot gurgling, a clock, a single scooter passing somewhere outside.
...
**Circle, in order:** the email field → the **password field** with a small "leave blank" tag →
the **Email me a sign-in link** button. Then in the inbox, circle the link itself.

**Voiceover:** "First the app. One email, one link, no password. Tap it on the phone that is coming with you today."

**On-screen text:** **Email me a sign-in link**
...
**Circle:** the QR code, then the share icon.

**Voiceover:** "Your own card is already there, at its own link. That QR is how the next leader scans you in. Save it to your home screen."

**On-screen text:** *Save it to your home screen*
...
phone held low. An espresso cup and keys beside his elbow. Warm window light from the left.
The phone screen is angled away and blown out by the window light, not readable.

CAMERA: Static, slightly above and behind his shoulder. Very slow drift in.

AUDIO: Thumbs on glass, a cup set down on wood, distant birds.

AVOID: readable screens, on-screen text, captions, logos, fast cuts, slow motion.
```

**Voiceover:** "Kitchen table, two minutes. Ride name. Date. Meeting point. Create. The ride exists, and so does your morning."

**On-screen text:** **New ride**
...
**Circle:** the **Notes** field.

**Voiceover:** "In the notes, a line for the group. Where you stop for coffee, the pace, the road that is still gravel."

**On-screen text:** *Notes → everyone on the ride sees this*
...
into the inside pocket of his olive jacket, then lifts a helmet off a hook and tucks it under
his arm. Warm light from a window beside the door. Phone screen not readable.

CAMERA: Waist height, static, letting him move through frame.

AUDIO: A zip, the helmet strap buckle, keys, a door latch.
...
in a loose row, riders arriving in ones and twos, pulling off helmets, shaking hands, laughing.
THE LEADER stands slightly apart with a phone already in his hand.

CAMERA: Wide, handheld, slow drift left to right across the group.

AUDIO: Idling two-stroke engines, helmets set down, overlapping friendly voices, birdsong.
...
Unhurried but continuous. Phone screen not readable, card face not readable.

CAMERA: Chest height, close, slight handheld sway, following the small movements.

AUDIO: A short soft electronic confirmation tone. Footsteps on gravel. Voices nearby.
...
teeth, taps at the screen for a few seconds, then hands the phone back with a small nod. Both
standing beside a parked Vespa. Phone screen not readable throughout.

CAMERA: Close on hands and the exchange, chest height, gentle handheld.

AUDIO: A glove pulled off, taps on glass, a short laugh, engines idling behind.

AVOID: readable screens, on-screen text, captions, logos, fast cuts, slow motion.
```

**Voiceover:** "Tap Sign waiver now and pass them the phone. They type their name, tick the box, and hand it back. Ecco."

**On-screen text:** **Sign waiver now** *(over screenshots 10 and 11)*
...
LEADER turns his phone around to face them and holds it up. The younger rider raises their own
phone toward it, then looks down at their own screen and starts typing. Both phone screens
angled away and not readable.

CAMERA: Side-on two shot, chest height, small handheld drift.

AUDIO: A short apologetic laugh, taps on glass, gravel underfoot, engines behind.
...
parked at angles. THE LEADER glances at his phone, gives a small unbothered shrug, and carries
on holding it up toward a rider stepping forward. Phone screen not readable.

CAMERA: Wide establishing, then a slow push toward THE LEADER.

AUDIO: Wind in trees, gravel underfoot, a distant engine, no traffic at all.
...
kickstands down, helmets hooked on mirrors. THE LEADER stands at the end of the row, takes out
his phone, taps once with his thumb, and puts it away. Phone screen not readable.

CAMERA: Low, tracking slowly along the row of kickstands, rising to find him at the end.

AUDIO: A cooling engine ticking, a helmet set on a seat, cafe chatter nearby.

AVOID: readable screens, on-screen text, captions, logos, fast cuts, slow motion.
```

**Voiceover:** "Sixty miles later, kickstands down. Tap submit. The roster goes in, and sign-in closes for good."

**On-screen text:** **Submit 18 riders** *(over screenshot 15)*
...
set down in front of THE LEADER, who is typing slowly with one thumb, taking his time. He
pauses, thinks, types again. Afternoon light, long soft shadows. Phone screen not readable.

CAMERA: Across the table at seated height, static, very slow push in.

AUDIO: A cup on a saucer, a spoon, quiet cafe murmur, a scooter passing.
...
**On-screen text:** *Every ride ends with a note*
...
SHOT: The cafe table now empty except for a drained espresso cup, a set of keys, and a helmet
on the chair. Beyond it, slightly out of focus, a Vespa pulls away down a tree-lined street.

CAMERA: Static on the table, letting the scooter leave frame in the background.

AUDIO: A scooter accelerating away and fading, birdsong, a cup cleared from a table.

AVOID: readable screens, on-screen text, captions, logos, fast cuts, slow motion.
```

**Voiceover:** "It is all on your rides list, with the safety guidance and club ride rules linked beside it. Same again next Sunday."

**On-screen text:** **vcdc.club** / *Safety guidance + ride rules linked in the app*
...
Seventeen shots. Maybe twenty minutes, in three sittings. Take them on the phone you'd
actually lead a ride with, portrait, do-not-disturb on so no notification banner lands in
frame.
...
| :--- | :--- | :--- | :--- |
| 1 | `/login` | Email filled, password box empty | The empty password box, then **Email me a sign-in link** |
| 2 | Your inbox | The sign-in email open | The link itself |
| 3 | Your card link | QR showing | The QR, then the share icon |
| 4 | `/ride` | Two or three demo rides listed | The **New ride** button |
| 5 | `/ride/new` | All four fields filled in | The **Notes** field |
...
| :--- | :--- | :--- |
| 16 | The **Submit 18 riders** button, list of riders above it | The button |
| 17 | The green **Submitted** panel | *The roster has been sent in* |
...
3.  Your own card is already there, at its own link. That QR is how the next leader scans you
    in. Save it to your home screen.

4.  Kitchen table, two minutes. Ride name. Date. Meeting point. Create. The ride exists, and so
    does your morning.
...
15. It is all on your rides list, with the safety guidance and club ride rules linked beside
    it. Same again next Sunday.
```

---

# Three things worth landing

If the video only lands three points, make them these.

1. **Open sign-in at home, on wifi.** The roster copies to the phone there and nowhere else.
...
# Say it the way the app says it

Match these exactly. Anything else sends people hunting for a button that is not there.

| In the app | Not |
| :--- | :--- |
| **Email me a sign-in link** | "request a code", "log in" |
| **New ride** | "create ride", "add ride" |
| **Ride name / Date / Meeting point / Notes** | "title", "location", "comments" |
| **Create ride** | "save", "start ride" |
| **Open sign-in** | "start scanning", "open scanner" |
| **Start camera** | "open camera", "scan" |
| **Checked in** | "accepted", "valid" |
| **Already on the list** | "duplicate", "already scanned" |
| **Covered by membership** | "no waiver needed" |
| **No waiver on file** | "waiver missing", "invalid" |
| **Sign waiver now** | "sign here", "add waiver" |
| **Show waiver code** | "guest QR", "waiver QR" |
| **Text them the waiver link** | "send waiver" |
| **Add contact info** | "update details" |
| **No signal** | "offline", "disconnected" |
| **N waiting to send** | "pending", "unsynced" |
| **Sync now** | "refresh", "update" |
| **Submit N riders** | "finish ride", "close ride" |
| **Signed in (N)** | "attendance", "roster" |

---

# If you only have 60 seconds

For the group chat: **B2 → B4 → B6 → B8 → B9 → B10 → B13**. Seven segments, 56 seconds, and it
still covers signing in, creating a ride, the roster download, scanning, the waiver line,
signing on the spot, and submitting.

Only B4, B6, B8 and B10 need Flow clips, so this cut is a single afternoon.
...
rewatch when they are stuck in a car park.
